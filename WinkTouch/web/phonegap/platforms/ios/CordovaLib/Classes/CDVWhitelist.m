...
{
    // an IPv4 address has 4 octets b.b.b.b where b is a number between 0 and ***REMOVED***.
    ...
    // restrict number parsing to 0-***REMOVED***
    NSNumberFormatter* numberFormatter = [[NSNumberFormatter alloc] init];
    [numberFormatter setMinimum:[NSNumber numberWithUnsignedInteger:0]];
    [numberFormatter setMaximum:[NSNumber numberWithUnsignedInteger:***REMOVED***]];

    // iterate through each octet, and test for a number between 0-***REMOVED*** or if it equals '*'
