...
import type { PatientInfo, FieldDefinition, PatientDrug, Visit, Exam} from './Types';
...
const medicationExamNames : string[] = ['Medication','Ocular medication','Prescription'];
...
export class PatientMedicationCard extends Component {
    ...
    async refreshPatientInfo() {
      ...
      let medication : ?PatientDrug[] = getRecentMedication(this.props.patientInfo.id);
    ...
    render() {
      ...
      return <ItemsList title={strings.medicationRxTitle} items={this.state.medication} showLabels={false} style={styles.tabCard}
        fieldDefinitions={patientDrugDefinition} editable={false}/>
    }
}
