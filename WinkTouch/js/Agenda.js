...
export class AgendaScreen extends Component {
  ...
  openDoctorsOptions = () => {
    this.setState({isUsersDialogVisible: true});
  };
  cancelDoctorsOptions = () => {
    this.setState({isUsersDialogVisible: false});
  };
  openPatientDialog = () => {
    ...
    return (
      <Portal theme={{colors: {backdrop: 'transparent'}}}>
        <Dialog
          ...
          visible={this.state.isUsersDialogVisible}
  ...
  render() {
    ...
    return (
      <View style={styles.page}>
        ...
        {isUsersDialogVisible && this.renderDoctorsOptions()}
