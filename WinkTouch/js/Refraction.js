...
export class GlassesDetail extends Component {
  ...
  constructor(props: any) {
    ...
    console.log('HAS MPDDD: ' + this.props.hasMPD);
  }
      ...
      <View
        ...
        <View style={styles.centeredColumnLayout}>
          ...
          <View style={styles.formRow}>
            ...
            <Text style={styles.formTableColumnHeader}>
              {formatLabel(getFieldDefinition('visit.prescription.od.cyl'))}
            </Text>
            <Text style={styles.formTableColumnHeader}>
              {formatLabel(getFieldDefinition('visit.prescription.od.axis'))}
            </Text>
            {this.state.prism && (
              <Text style={styles.formTableColumnHeaderWide}>
                {formatLabel(
            ...
            <View style={styles.formRow}>
              <GroupedForm
                ...
                onChangeField={(
                  ...
                  newValue: any,
                  column: ?string,
                ) => this.updateGroupedForm('mpd', fieldName, newValue, column)}
              />
            </View>
          )}
