...
export const strings = new LocalizedStrings({
    en: {
      ...
      initialiseError: 'Something went wrong while initialising. Please kill and restart the app.\n\n(Internal error fetching {0} = {1})',
    ...
    fr: {
      ...
      initialiseError: 'Une erreur s\'est produite au demarage. Veuillez redémarrer l\'application.\n\n(Erreur interne en chargeant {0} = {1})',
