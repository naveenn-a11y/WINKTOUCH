...
const checkBoxStyle = StyleSheet.create({checkBoxStyle: {fontSize: 18 * fontScale, fontStyle: 'italic', backgroundColor: 'white'}}).checkBoxStyle;
...
export class PaperFormScreen extends Component {
    ...
    updateFieldValue(fieldIdentifier: string, newValue: any) {
      ...
      if (fieldSrc==='exam') {
        ...
        setValue(exam, this.props.exam.definition.name+"."+fieldIdentifier, newValue);
      ...
      return <ScrollView minimumZoomScale={1.0} maximumZoomScale={2.0} bounces={false} bouncesZoom={false} scrollEnabled={this.state.scrollEnabled} pinchGestureEnabled={this.state.scrollEnabled}>
        <View>
          ...
          >
            ...
            <View style={{position: 'absolute', top:10 * fontScale, left: 990 * fontScale, width: 100*fontScale, height: 40*fontScale, justifyContent:'center'}}>
              <FormInput value={'Z'+stripDataType(getFieldValue('patient.id', this.props.exam))} definition={getFieldDefinition('patient.lastName', this.props.exam)} showLabel={false} readonly={true}  style={textLeftStyle} />
            </View>
          ...
          <ImageField image='./image/ToulchExamBack.jpg' resolution='811x1071' size='XL'  popup={false} value={this.props.exam[examName]['Exam Back Page']}
            disableScroll={this.disableScroll} enableScroll={this.enableScroll} examId={this.props.exam.id} patientId={getPatient(this.props.exam).id}
            fileName='Exam back.jpg' type='examen de la vue' onChangeValue={(value: ?string) => this.updateFieldValue('Exam Back Page', value)}
          />

          <ImageField image='./image/ToulchMeds.jpg' resolution='600x826' size='L'  popup={false} value={this.props.exam[examName]['Medication Rx']}
            disableScroll={this.disableScroll} enableScroll={this.enableScroll} examId={this.props.exam.id} patientId={getPatient(this.props.exam).id}
            fileName='Rx.jpg' type='prescription' onChangeValue={(value: ?string) => this.updateFieldValue('Medication Rx', value)}
          />
        </View>
      </ScrollView>
    }
    ...
    renderEyeExamTemplate() {
        ...
        const examName : string = this.props.exam.definition.name;
        return <ScrollView minimumZoomScale={1.0} maximumZoomScale={2.0} bounces={false} bouncesZoom={false} scrollEnabled={this.state.scrollEnabled} pinchGestureEnabled={this.state.scrollEnabled}>
        <ImageField image='./image/eyeexamtemplate.png' resolution='763x965' size='XL'  popup={false} value={this.props.exam[examName]['Chart']}
          disableScroll={this.disableScroll} enableScroll={this.enableScroll} examId={this.props.exam.id} patientId={getPatient(this.props.exam).id}
          fileName='Chart.jpg' type='chart' onChangeValue={(value: ?string) => this.updateFieldValue('Chart', value)}
        >
        <View style={{position: 'absolute', top:65 * fontScale, left: 72 * fontScale, width: 60*fontScale, height: 55*fontScale, justifyContent:'center'}}>
        ...
        <View style={{position: 'absolute', top:65 * fontScale, left: 136 * fontScale, width: 63*fontScale, height: 55*fontScale, justifyContent:'center'}}>
          <FormInput value={getFieldValue('VA cc.Aided acuities.DVA.OD', this.props.exam)} definition={getFieldDefinition('exam.VA cc.Aided acuities.DVA.OD', this.props.exam)} showLabel={false} readonly={this.props.editable!==true}
            onChangeValue={(value: ?number) => this.updateFieldValue('VA cc.Aided acuities.DVA.OD', value)}  style={smallTextStyle} />
        </View>
        <View style={{position: 'absolute', top:65 * fontScale, left: 205 * fontScale, width: 63*fontScale, height: 55*fontScale, justifyContent:'center'}}>
          <FormInput value={getFieldValue('VA sc.Unaided acuities.NVA.OD', this.props.exam)} definition={getFieldDefinition('exam.VA sc.Unaided acuities.NVA.OD', this.props.exam)} showLabel={false} readonly={this.props.editable!==true}
            onChangeValue={(value: ?number) => this.updateFieldValue('VA sc.Unaided acuities.NVA.OD', value)}  style={smallTextStyle} />
        </View>
        <View style={{position: 'absolute', top:65 * fontScale, left: 272 * fontScale, width: 66*fontScale, height: 55*fontScale, justifyContent:'center'}}>
          <FormInput value={getFieldValue('VA cc.Aided acuities.NVA.OD', this.props.exam)} definition={getFieldDefinition('exam.VA cc.Aided acuities.NVA.OD', this.props.exam)} showLabel={false} readonly={this.props.editable!==true}
            onChangeValue={(value: ?number) => this.updateFieldValue('VA cc.Aided acuities.NVA.OD', value)}  style={smallTextStyle} />
        </View>
        <View style={{ position: 'absolute', top:65 * fontScale, left: 448 * fontScale, width: 79*fontScale, height: 55*fontScale, justifyContent:'center'}}>
          <FormInput value={getFieldValue('Old Rx.od.sph', this.props.exam)} definition={getFieldDefinition('exam.RxToOrder.Final Rx.od.sph', this.props.exam)} showLabel={false} readonly={this.props.editable!==true}
            onChangeValue={(value: ?number) => this.updateFieldValue('Old Rx.od.sph', value)}  style={textStyle} />
        </View>
        <View style={{position: 'absolute', top:65 * fontScale, left: 531 * fontScale, width: 79*fontScale, height: 54*fontScale, justifyContent:'center'}}>
          <FormInput value={getFieldValue('Old Rx.od.cyl', this.props.exam)} definition={getFieldDefinition('exam.RxToOrder.Final Rx.od.cyl', this.props.exam)} showLabel={false} readonly={this.props.editable!==true}
            onChangeValue={(value: ?number) => this.updateFieldValue('Old Rx.od.cyl', value)}  style={textStyle} />
        </View>
        <View style={{position: 'absolute', top:65 * fontScale, left: 615 * fontScale, width: 71*fontScale, height: 54*fontScale,  justifyContent:'center'}}>
          <FormInput value={getFieldValue('Old Rx.od.axis', this.props.exam)} definition={getFieldDefinition('exam.RxToOrder.Final Rx.od.axis', this.props.exam)} showLabel={false} readonly={this.props.editable!==true}
            onChangeValue={(value: ?number) => this.updateFieldValue('Old Rx.od.axis', value)}  style={textStyle} />
        </View>
        <View style={{position: 'absolute', top:65 * fontScale, left: 690 * fontScale, width: 84*fontScale, height: 54*fontScale, justifyContent:'center'}}>
          <FormInput value={getFieldValue('Old Rx.od.add', this.props.exam)} definition={getFieldDefinition('exam.RxToOrder.Final Rx.od.add', this.props.exam)} showLabel={false} readonly={this.props.editable!==true}
            onChangeValue={(value: ?number) => this.updateFieldValue('Old Rx.od.add', value)}  style={textStyle} />
        </View>

        <View style={{position: 'absolute', top:124 * fontScale, left: 72 * fontScale, width: 60*fontScale, height: 55*fontScale, justifyContent:'center'}}>
          <FormInput value={getFieldValue('VA sc.Unaided acuities.DVA.OS', this.props.exam)} definition={getFieldDefinition('exam.VA sc.Unaided acuities.DVA.OS', this.props.exam)} showLabel={false} readonly={this.isFieldReadonly()}
            onChangeValue={(value: ?number) => this.updateFieldValue('VA sc.Unaided acuities.DVA.OS', value)}  style={smallTextStyle} />
        </View>
        <View style={{position: 'absolute', top:124 * fontScale, left: 136 * fontScale, width: 63*fontScale, height: 55*fontScale, justifyContent:'center'}}>
          <FormInput value={getFieldValue('VA cc.Aided acuities.DVA.OS', this.props.exam)} definition={getFieldDefinition('exam.VA cc.Aided acuities.DVA.OS', this.props.exam)} showLabel={false} readonly={this.props.editable!==true}
            onChangeValue={(value: ?number) => this.updateFieldValue('VA cc.Aided acuities.DVA.OS', value)}  style={smallTextStyle} />
        </View>
        <View style={{position: 'absolute', top:124 * fontScale, left: 205 * fontScale, width: 63*fontScale, height: 55*fontScale, justifyContent:'center'}}>
          <FormInput value={getFieldValue('VA sc.Unaided acuities.NVA.OS', this.props.exam)} definition={getFieldDefinition('exam.VA sc.Unaided acuities.NVA.OS', this.props.exam)} showLabel={false} readonly={this.props.editable!==true}
            onChangeValue={(value: ?number) => this.updateFieldValue('VA sc.Unaided acuities.NVA.OS', value)}  style={smallTextStyle} />
        </View>
        <View style={{position: 'absolute', top:124 * fontScale, left: 272 * fontScale, width: 66*fontScale, height: 55*fontScale, justifyContent:'center'}}>
          <FormInput value={getFieldValue('VA cc.Aided acuities.NVA.OS', this.props.exam)} definition={getFieldDefinition('exam.VA cc.Aided acuities.NVA.OS', this.props.exam)} showLabel={false} readonly={this.props.editable!==true}
            onChangeValue={(value: ?number) => this.updateFieldValue('VA cc.Aided acuities.NVA.OS', value)}  style={smallTextStyle} />
        </View>
        <View style={{position: 'absolute', top:124 * fontScale, left: 448 * fontScale, width: 79*fontScale, height: 55*fontScale, justifyContent:'center'}}>
          <FormInput value={getFieldValue('Old Rx.os.sph', this.props.exam)} definition={getFieldDefinition('exam.RxToOrder.Final Rx.os.sph', this.props.exam)} showLabel={false} readonly={this.props.editable!==true}
            onChangeValue={(value: ?number) => this.updateFieldValue('Old Rx.os.sph', value)}  style={textStyle} />
        </View>
        <View style={{position: 'absolute', top:124 * fontScale, left: 531 * fontScale, width: 79*fontScale, height: 54*fontScale, justifyContent:'center'}}>
          <FormInput value={getFieldValue('Old Rx.os.cyl', this.props.exam)} definition={getFieldDefinition('exam.RxToOrder.Final Rx.os.cyl', this.props.exam)} showLabel={false} readonly={this.props.editable!==true}
            onChangeValue={(value: ?number) => this.updateFieldValue('Old Rx.os.cyl', value)}  style={textStyle} />
        </View>
        <View style={{position: 'absolute', top:124 * fontScale, left: 615 * fontScale, width: 71*fontScale, height: 54*fontScale,  justifyContent:'center'}}>
          <FormInput value={getFieldValue('Old Rx.os.axis', this.props.exam)} definition={getFieldDefinition('exam.RxToOrder.Final Rx.os.axis', this.props.exam)} showLabel={false} readonly={this.props.editable!==true}
            onChangeValue={(value: ?number) => this.updateFieldValue('Old Rx.os.axis', value)}  style={textStyle} />
        </View>
        <View style={{position: 'absolute', top:124 * fontScale, left: 690 * fontScale, width: 84*fontScale, height: 54*fontScale, justifyContent:'center'}}>
          <FormInput value={getFieldValue('Old Rx.os.add', this.props.exam)} definition={getFieldDefinition('exam.RxToOrder.Final Rx.os.add', this.props.exam)} showLabel={false} readonly={this.props.editable!==true}
            onChangeValue={(value: ?number) => this.updateFieldValue('Old Rx.os.add', value)}  style={textStyle} />
        </View>

        <View style={{position: 'absolute', top:181 * fontScale, left: 72 * fontScale, width: 60*fontScale, height: 55*fontScale, justifyContent:'center'}}>
          <FormInput value={getFieldValue('VA sc.Unaided acuities.DVA.OU', this.props.exam)} definition={getFieldDefinition('exam.VA sc.Unaided acuities.DVA.OU', this.props.exam)} showLabel={false} readonly={this.isFieldReadonly()}
            onChangeValue={(value: ?number) => this.updateFieldValue('VA sc.Unaided acuities.DVA.OU', value)}  style={smallTextStyle} />
        </View>
        <View style={{position: 'absolute', top:181 * fontScale, left: 136 * fontScale, width: 63*fontScale, height: 55*fontScale, justifyContent:'center'}}>
          <FormInput value={getFieldValue('VA cc.Aided acuities.DVA.OU', this.props.exam)} definition={getFieldDefinition('exam.VA cc.Aided acuities.DVA.OU', this.props.exam)} showLabel={false} readonly={this.props.editable!==true}
            onChangeValue={(value: ?number) => this.updateFieldValue('VA cc.Aided acuities.DVA.OU', value)}  style={smallTextStyle} />
        </View>
        <View style={{position: 'absolute', top:181 * fontScale, left: 203 * fontScale, width: 63*fontScale, height: 55*fontScale, justifyContent:'center'}}>
          <FormInput value={getFieldValue('VA sc.Unaided acuities.NVA.OU', this.props.exam)} definition={getFieldDefinition('exam.VA sc.Unaided acuities.NVA.OU', this.props.exam)} showLabel={false} readonly={this.props.editable!==true}
            onChangeValue={(value: ?number) => this.updateFieldValue('VA sc.Unaided acuities.NVA.OU', value)}  style={smallTextStyle} />
        </View>
        <View style={{position: 'absolute', top:181 * fontScale, left: 272 * fontScale, width: 66*fontScale, height: 55*fontScale, justifyContent:'center'}}>
          <FormInput value={getFieldValue('VA cc.Aided acuities.NVA.OU', this.props.exam)} definition={getFieldDefinition('exam.VA cc.Aided acuities.NVA.OU', this.props.exam)} showLabel={false} readonly={this.props.editable!==true}
            onChangeValue={(value: ?number) => this.updateFieldValue('VA cc.Aided acuities.NVA.OU', value)}  style={smallTextStyle} />
        </View>

        <View style={{position: 'absolute', top:253 * fontScale, left: 530 * fontScale, backgroundColor:'#ffffffff'}}>
          <CheckButton prefix='( ' suffix='routine exam)' isChecked={getFieldValue('Routine exam', this.props.exam)}
