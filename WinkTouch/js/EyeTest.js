...
export class StrabismusWheel extends Component {
  ...
  render() {
    return (
      <TilesField
        value={this.state.strabismus}
        options={strabismusTypes}
        {...this.props}
        onChangeValue={(strabismus: string) =>
          this.setState({strabismus: strabismus})
        }
      />
    );
  }
  ...
  render() {
    return (
      <TilesField
        ...
        options={handednessTypes}
        {...this.props}
        onChangeValue={(handedness: string) =>
          this.setState({handedness: handedness})
        }
      />
    );
  }
...
export class VisualFieldWheel extends Component {
  ...
  render() {
    return (
      <TilesField
        value={this.state.visualField}
        options={visualFieldTypes}
        {...this.props}
        onChangeValue={(visualField: string) =>
          this.setState({visualField: visualField})
        }
      />
    );
  }
...
export class PupilDiagnoseWheel extends Component {
  ...
  render() {
    return (
      <TilesField
        value={this.state.pupilDiagnose}
        options={pupilDiagnoseTypes}
        {...this.props}
        onChangeValue={(pupilDiagnose: string) =>
          this.setState({pupilDiagnose: pupilDiagnose})
        }
      />
    );
  }
...
export class IrisColorWheel extends Component {
  ...
  render() {
    return (
      <TilesField
        value={this.state.irisColor}
        options={irisColorTypes}
        {...this.props}
        onChangeValue={(irisColor: string) =>
          this.setState({irisColor: irisColor})
        }
      />
    );
  }
  ...
  render() {
      ...
      return (
        <View style={styles.board}>
          ...
          <Text style={styles.text}>
            {this.state.administeredAge}minutes ago
          </Text>
        </View>
      );
    }
    return (
      <View style={styles.board}>
        <Text style={styles.screenTitle}>Anesthetics</Text>
        <Button
          title="Administer now"
          onPress={() =>
            this.state.drug && this.props.onAdminister(this.state.drug)
          }
        />
      </View>
    );
      ...
      <View style={styles.board}>
        ...
        <View style={styles.centeredColumnLayout}>
          <View style={styles.centeredRowLayout}>
            ...
            <PupilDiagnoseWheel
              style={styles.formField}
              pupilDiagnose={'Horners Syndrome'}
            />
          </View>
          <View style={styles.centeredRowLayout}>
            <Text style={styles.formLabel}>OS:</Text>
