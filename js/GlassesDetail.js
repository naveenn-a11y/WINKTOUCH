...
import type {GlassesRx, Patient, Exam, GroupDefinition, Measurement, FieldDefinition} from './Types';
import {styles} from './Styles';
import {strings} from './Strings';
import {Button, Label, NativeBar, Alert} from './Widgets';
import {deepClone, isEmpty, formatDate, now, jsonDateTimeFormat} from './Util';
...
export class GlassesDetail extends Component {
  ...
  updateGroupedForm(groupName: string, fieldName: string, newValue: any, column: ?string): void {
    let glassesRx: GlassesRx = this.props.glassesRx;
    if (column !== undefined) {
  ...
  async importData() {
    ...
    if (data instanceof Array) {
      ...
      let glassesRx: GlassesRx = this.props.glassesRx;
      glassesRx.lensType = this.props.definition.hasLensType ? data.data.lensType : undefined;
  ...
  hasVA(): boolean {
    return (
      this.props.hasVA ||
      (this.props.isPrescriptionCard && !isEmpty(this.props.glassesRx.od) && !isEmpty(this.props.glassesRx.od.va)) ||
      (this.props.isPrescriptionCard && !isEmpty(this.props.glassesRx.os) && !isEmpty(this.props.glassesRx.os.va)) ||
      (this.props.isPrescriptionCard && !isEmpty(this.props.glassesRx.ou) && !isEmpty(this.props.glassesRx.ou.va))
    );
  }
  ...
  getRxNotesDefinition(): FieldDefinition {
    let definition: FieldDefinition = deepClone(getFieldDefinition('visit.prescription.notes'));
  ...
  renderLabel(props) {
    ...
    return <Label suffix="" style={props.titleStyle} value={props.title} fieldId={props.fieldId} />;
  }
  ...
  determineStyle(props, state) {
    ...
    if (props.hasCurrentWear) {
      return styles.boardL;
    }
    if (state.prism && this.hasVA()) {
      return styles.boardXL;
    }
    if (state.prism || this.hasVA()) {
      return styles.boardL;
    }
  ...
  renderButton(condition, title, onPress, testID) {
    ...
    return <Button title={title} onPress={onPress} testID={testID} />;
  }
  ...
  renderOdOsOuSection(props, state) {
    const isTyping = this.context.keyboardMode === 'desktop' || state.isTyping;
    ...
    const glassesRows = [
      {
        ...
        columns: [
          ...
          this.createColumn(
            ...
            false,
            true,
            props.glassesRx?.od?.axisError ?? '',
          ),
          this.createColumn(
            props,
            'od',
            'prism',
            'visit.prescription.od.prism',
            true,
            state.prism,
            props.glassesRx?.od?.prismError ?? '',
          ),
          this.createColumn(
            props,
            'od',
            ...
            false,
            this.hasVA(),
            props.glassesRx?.od?.vaError ?? '',
          ),
          this.createColumn(
            props,
            'od',
            'add',
            'visit.prescription.od.add',
            false,
            props.hasAdd,
            props.glassesRx?.od?.addError ?? '',
          ),
          this.createColumn(
            props,
            'od',
            ...
            false,
            this.hasNVA(),
            props.glassesRx?.od?.addVaError ?? '',
          ),
          this.createColumn(
            props,
            'od',
            'bvd',
            'visit.prescription.od.bvd',
            false,
            this.hasBvd(),
            props.glassesRx?.od?.bvdError ?? '',
          ),
        ],
      },
      {
        ...
        columns: [
          ...
          this.createColumn(
            ...
            false,
            true,
            props.glassesRx?.os?.axisError ?? '',
          ),
          this.createColumn(
            props,
            'os',
            'prism',
            'visit.prescription.os.prism',
            true,
            state.prism,
            props.glassesRx?.os?.prismError ?? '',
          ),
          this.createColumn(
            props,
            'os',
          ...
          this.createColumn(
            ...
            false,
            this.hasNVA(),
            props.glassesRx?.os?.addVaError ?? '',
          ),
          this.createColumn(
            props,
            'os',
            'bvd',
            'visit.prescription.os.bvd',
            false,
            this.hasBvd(),
            props.glassesRx?.os?.bvdError ?? '',
          ),
        ],
      },
      {
  ...
  renderPdSection(props, state) {
    if (props.hasPD === undefined) {
      return null;
    }
    if (props.hasPD === null) {
      return null;
    }
    if (props.hasPD === false) {
      return null;
    }
    ...
    const pdRows = [
      {
        ...
        columns: [
          ...
          this.createColumn(
            ...
            false,
            true,
            props.glassesRx?.od?.closePDError ?? '',
          ),
        ],
      },
      {
        ...
        columns: [
          ...
          this.createColumn(
            ...
            false,
            true,
            props.glassesRx?.os?.closePDError ?? '',
          ),
        ],
      },
      {
        ...
        columns: [
          ...
          this.createColumn(
            ...
            false,
            true,
            props.glassesRx?.ou?.closePDError ?? '',
          ),
        ],
      },
    ];
  ...
  render() {
    ...
    const isTyping = this.context.keyboardMode === 'desktop' || this.state.isTyping;
    ...
    return (
      <View style={this.determineStyle(this.props, this.state)}>
        ...
        <View style={styles.centeredColumnLayout}>
          {this.props.hasCurrentWear && this.renderFormInputAlt(this.props, 'currentWear', 'Current wear')}
          ...
          {this.props.editable && (
            <View style={styles.buttonsRowLayout}>
              {this.renderButton(
                this.props.hasAdd,
                formatLabel(getFieldDefinition('visit.prescription.od.prism')),
                this.togglePrism,
                `${this.props.fieldId}.prismButton`,
              )}
              {this.renderButton(
                this.props.onCopyToFinalRx,
                strings.copyToFinal,
                () => this.props.onCopyToFinalRx(this.props.glassesRx),
                `${this.props.fieldId}.copyFinalRxButton`,
              )}
            </View>
          )}
        ...
        <View style={styles.groupIcons}>
          {this.renderIcon(
            this.props.editable,
            this.props.onClear ? this.props.onClear : this.clear,
            Garbage,
            `${this.props.fieldId}.garbageIcon`,
          )}
          ...
          {this.renderIcon(
            ...
            this.props.onAdd,
            Plus,
            `${this.props.fieldId}.addIcon`,
          )}
          {this.renderIcon(
            this.props.editable && this.props.onPaste,
            () => this.props.onPaste(this.props.definition),
            Paste,
            `${this.props.fieldId}.pasteIcon`,
          )}
          {this.renderIcon(
            this.props.onCopy && !this.props.onPaste,
            () => this.props.onCopy(this.props.glassesRx),
            Copy,
          )}
          {this.renderIcon(
            this.props.editable && this.props.onCopyFromFinal,
            () => this.props.onCopyFromFinal(this.props.glassesRx),
            Copy,
          )}
        </View>
